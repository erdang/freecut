...
describe('resolveAnimatedCrop', () => {
  it('interpolates crop edge and softness keyframes in pixel space', () => {
    ...
    expect(getCropPropertyValue(resolved, 'cropLeft', { width: 1920, height: 1080 })).toBeCloseTo(192);
    expect(getCropPropertyValue(resolved, 'cropSoftness', { width: 1920, height: 1080 })).toBeCloseTo(27);
  });
});
