...
const MODEL_CONFIGS = {
  fp32: {
    ...
    dtype: 'fp32',
    cacheMatchFragments: ['/onnx-community/kokoro-82m-v1.0-onnx/', '/onnx/model.onnx'],
  },
...
export const KOKORO_TTS_VOICE_OPTIONS = [
  { value: 'af_heart', label: 'Heart（美式，女声）' },
  { value: 'af_bella', label: 'Bella（美式，女声）' },
  { value: 'af_nicole', label: 'Nicole（美式，女声）' },
  { value: 'af_sky', label: 'Sky（美式，女声）' },
  { value: 'af_sarah', label: 'Sarah（美式，女声）' },
  { value: 'af_alloy', label: 'Alloy（美式，女声）' },
  { value: 'af_aoede', label: 'Aoede（美式，女声）' },
  { value: 'af_jessica', label: 'Jessica（美式，女声）' },
  { value: 'af_kore', label: 'Kore（美式，女声）' },
  { value: 'af_nova', label: 'Nova（美式，女声）' },
  { value: 'af_river', label: 'River（美式，女声）' },
  { value: 'am_michael', label: 'Michael（美式，男声）' },
  { value: 'am_fenrir', label: 'Fenrir（美式，男声）' },
  { value: 'am_puck', label: 'Puck（美式，男声）' },
  { value: 'am_adam', label: 'Adam（美式，男声）' },
  { value: 'am_echo', label: 'Echo（美式，男声）' },
  { value: 'am_eric', label: 'Eric（美式，男声）' },
  { value: 'am_liam', label: 'Liam（美式，男声）' },
  { value: 'am_onyx', label: 'Onyx（美式，男声）' },
  { value: 'am_santa', label: 'Santa（美式，男声）' },
  { value: 'bf_emma', label: 'Emma（英式，女声）' },
  { value: 'bf_isabella', label: 'Isabella（英式，女声）' },
  { value: 'bf_alice', label: 'Alice（英式，女声）' },
  { value: 'bf_lily', label: 'Lily（英式，女声）' },
  { value: 'bm_george', label: 'George（英式，男声）' },
  { value: 'bm_fable', label: 'Fable（英式，男声）' },
  { value: 'bm_lewis', label: 'Lewis（英式，男声）' },
  { value: 'bm_daniel', label: 'Daniel（英式，男声）' },
] as const
...
export function getKokoroTtsVoiceOption(voice: KokoroTtsVoice): {
  value: KokoroTtsVoice
  label: string
} {
  return (
    KOKORO_TTS_VOICE_OPTIONS.find((option) => option.value === voice) ?? {
      value: voice,
      label: voice,
    }
  )
