...
export const MOSS_TTS_VOICE_OPTIONS = [
  { value: 'Junhao', label: 'Junhao（中文，男声）' },
  { value: 'Zhiming', label: 'Zhiming（中文，男声）' },
  { value: 'Weiguo', label: 'Weiguo（中文，男声）' },
  { value: 'Xiaoyu', label: 'Xiaoyu（中文，女声）' },
  { value: 'Yuewen', label: 'Yuewen（中文，女声）' },
  { value: 'Lingyu', label: 'Lingyu（中文，女声）' },
  { value: 'Trump', label: 'Trump（英文，男声）' },
  { value: 'Ava', label: 'Ava（英文，女声）' },
  { value: 'Bella', label: 'Bella（英文，女声）' },
  { value: 'Adam', label: 'Adam（英文，男声）' },
  { value: 'Nathan', label: 'Nathan（英文，男声）' },
  { value: 'Soyo', label: 'Soyo（日文，女声）' },
  { value: 'Saki', label: 'Saki（日文，女声）' },
  { value: 'Mortis', label: 'Mortis（日文，女声）' },
  { value: 'Umiri', label: 'Umiri（日文，女声）' },
  { value: 'Mei', label: 'Mei（日文，女声）' },
  { value: 'Anon', label: 'Anon（日文，女声）' },
  { value: 'Arisa', label: 'Arisa（日文，女声）' },
] as const
