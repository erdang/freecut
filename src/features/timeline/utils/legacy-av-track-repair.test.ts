...
describe('repairLegacyAvTrackLayout', () => {
  it('splits legacy video audio onto paired tracks and preserves standalone audio tracks', () => {
    const result = repairLegacyAvTrackLayout({
      ...
      items: [
        ...
        makeAudioItem({ id: 'music-1', trackId: 'track-music', mediaId: 'music-1', label: 'Music Bed' }),
      ],
      keyframes: [],
      fps: 30,
  ...
  it('moves existing companion audio to the matching paired lane and clones volume keyframes for generated audio', () => {
    ...
    const result = repairLegacyAvTrackLayout({
      ...
      items: [
        makeVideoItem({ id: 'video-1', trackId: 'track-v2', mediaId: 'media-1', from: 15, durationInFrames: 45 }),
        makeAudioItem({ id: 'audio-1', trackId: 'track-a-loose', mediaId: 'media-1', from: 15, durationInFrames: 45 }),
        makeVideoItem({ id: 'video-2', trackId: 'track-v1', mediaId: 'media-2', from: 0, durationInFrames: 30 }),
      ],
